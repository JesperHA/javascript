...
export default class UserFacade {
    ...
    // der skal oprettes en bruger via postman før password matcher da bcrypt
    // prøver at sammenligne det hashede password med det hardcodede password som ikke er hashet.
