  ...
  */
  ...
  onCenterGameArea = () => {
    ...
    for (let i in gameArea) {
      x = x + gameArea[i].latitude
      y = y + gameArea[i].longitude
    }

    const latitude = x / gameArea.length
    const longitude = y / gameArea.length
  ...
  return (
    <View style={{ flex: 1, paddingTop: 20 }}>
      ...
      >
        ...
        <MapView.Marker title="You" pinColor="blue"
